...
public class Basic {
    public static void main(String[] args) {
        /*
           ...
           같은 스코프(Scope) 안에서는 (같은 블로 안에서는) 같은 이름의 변수 선언은 최초 한번만 한다.
           int num;
           float num2;
           ...
           - 특수기호 중 _ $는 변수명으로 사용 가능 (문자로 보기 때문에 시작문자로 사용 가능 하다.)
           - 예약어는 사용 불가능
           - 대소문자를 가린다.
           - 카멜 스타일로 작성

           변수면 센스
           - 의미가 있는 이름을 사용하는게 좋다. 최악 : a,b,c (의미를 알수없기 때문)
           - 너무 길지 않도록(효율성을 위해)
           - 축약형으로 사용 desc:description, name: nm, class: cls etc...
